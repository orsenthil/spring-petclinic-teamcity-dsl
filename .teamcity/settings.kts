...
project {
    ...
    vcsRoot(HttpsGithubComOrsenthilSpringPetclinicRefsHeadsMain)
...
object Build : BuildType({
    ...
    vcs {
        root(HttpsGithubComOrsenthilSpringPetclinicRefsHeadsMain)
    }
...
object HttpsGithubComOrsenthilSpringPetclinicRefsHeadsMain : GitVcsRoot({
